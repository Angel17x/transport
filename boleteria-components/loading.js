(function (app) {
    ...
    app.LoadingServiceComponent = ng.core
        .Component({
            ...
            template: '<div class="modal" tabindex="-1" role="dialog" data-bs-backdrop="static" style="text-align:center;margin-top:180px;" scroll="no" id="pleaseWaitDialog" data-bs-backdrop="static" data-backdrop="static" data-keyboard="false">'+
