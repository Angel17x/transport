(function(app) {
	app.ReservationAllReportComponent =
		ng.core.Component({
		selector: 'reservation-report-all',
		templateUrl: 'views/reservation-report-all.html',
		})
		.Class({
	...
	app.ReservationAllReportComponent.prototype.ngOnInit=function(){
	...
	app.ReservationAllReportComponent.prototype.checkRol=function(){
		this.actions=[];
		this.vistas=[];
		var flag=false;
	...
	app.ReservationAllReportComponent.prototype.formattedActions=function(data){
	...
	app.ReservationAllReportComponent.prototype.formattedView=function(data){
		if(data==null || data==undefined || data==""){
			return null;
		}else{
			if(data.name=="CREATE-RESERVATION-LINE"){
	...
	app.ReservationAllReportComponent.prototype.search=function(){
		this.jsonFilter={};
		...
		if(!(this.viaje==null || this.viaje==undefined || this.viaje=="")){
			this.viaje=(this.viaje+"").trim();
			if(this.viaje!=""){
				if(!utils_keyNumber(this.viaje)){
					this.mensaje="El formato del número de viaje es incorrecto, se permiten sólo números";
					this.msg.warning();
					return;
				}
				this.jsonFilter.trip_sequence={};
				this.jsonFilter.trip_sequence.lte=parseInt(this.viaje);
				this.jsonFilter.trip_sequence.gte=parseInt(this.viaje);
			}
			
		}
		this.callServices(1, "&limit="+this.detallePorPagina);
	}
	app.ReservationAllReportComponent.prototype.clean=function(){
		this.init=null;
		this.end=null;
		this.canal=null;
		this.status=null;
	...
	app.ReservationAllReportComponent.prototype.getCantidadSelected=function(data){
		if (!(data == null || data == undefined || data == "")) {
	...
	app.ReservationAllReportComponent.prototype.getValueFirst=function(data){
		this.listRegister = [];
	...
	app.ReservationAllReportComponent.prototype.getValuePrevious=function(data){
		this.listRegister = [];
	...
	app.ReservationAllReportComponent.prototype.getValueLast=function(data){
		this.listRegister = [];
	...
	app.ReservationAllReportComponent.prototype.getValueNext=function(data){
		this.listRegister = [];
	...
	app.ReservationAllReportComponent.prototype.getValueChangeRecords=function(data){
		this.pageSelected = data;
	}
	app.ReservationAllReportComponent.prototype.callServices = function (data, parametros) {
		...
		let request = this.service.callServicesHttp("reservation-report", querys, this.jsonFilter);
	...
	app.ReservationAllReportComponent.prototype.procesarRespuesta=function(data){
		var key="results";
	...
	app.ReservationAllReportComponent.prototype.checkAction=function(data){
	...
	app.ReservationAllReportComponent.prototype.formattedData=function(data){
		if(data==null || data==undefined || data==""){
			return null;
		}else{
	...
	app.ReservationAllReportComponent.prototype.deselectedData = function() {
		this.dataSelected = null;
	}
	app.ReservationAllReportComponent.prototype.selectedAction = function(data, action) {
	...
	app.ReservationAllReportComponent.prototype.reservar=function(){
	...
	app.ReservationAllReportComponent.prototype.deleteData=function(){
	...
	app.ReservationAllReportComponent.prototype.cancelData=function(){
	...
	app.ReservationAllReportComponent.prototype.back=function(){
		window.history.back();
	}
