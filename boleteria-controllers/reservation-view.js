(function(app) {
	...
	app.ReservationViewComponent.prototype.ngOnInit=function(){
		this.title=_("title64")
		this.listItems=[];
        this.checkRol();
	}
	app.ReservationViewComponent.prototype.checkRol=function(){
		var texto="RESERVATION-LINE-VIEW";
		var flag=false;
	...
	app.ReservationViewComponent.prototype.getData=function(){
	...
	app.ReservationViewComponent.prototype.getReservation=function(){
	...
	app.ReservationViewComponent.prototype.formattedData=function(data){
		this.parada=null;
	...
	app.ReservationViewComponent.prototype.back=function(){
        window.history.back();
    }
	app.ReservationViewComponent.prototype.print=function(){
		window.print();
	}
