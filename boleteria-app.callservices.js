(function(app) {
	...
	app.AppCallService.prototype.callServicesHttp=function(ser,querys,param){
		...
		switch(ser){
			...
			case 'price-short-route-post':{
				request=this.callServices(this.enlace_api+'/short_route_price?realm='+getRealm()+querys,"POST",param,null,true,"JSON","text/plain",true,null);
				return request;
			}break;
			default:{
			}
	...
	app.AppCallService.prototype.getBusinessId=function(){
		return "06e32ef0-c2b2-11e9-a317-6bafaa74675d";	
	}
